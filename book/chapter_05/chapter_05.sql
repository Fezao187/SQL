...
-- Listing 5.2
-- Int and decimal division with SQL
...
-- Listing 5.4
-- Select census population by race
SELECT geo_name,
...
-- Listing 5.5
-- Adding two columsn in us_counties
SELECT geo_name,
       state_us_abbreviation AS "st",
       p0010003 AS "White Alone",
...
-- Listing 5.7
-- Calculating the percentage of the population that is Asian by county
SELECT geo_name,
       state_us_abbreviation AS "st",
