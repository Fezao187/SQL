...
FROM 'C:\BootCamp\7_PostgresSQL\My_SQL\book\chapter_09\MPI_Directory_by_Establishment_Name.csv'
...
COPY state_regions
FROM 'C:\BootCamp\7_PostgresSQL\My_SQL\book\chapter_09\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
