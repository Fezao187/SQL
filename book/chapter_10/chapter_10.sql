...
FROM 'C:\BootCamp\7_PostgresSQL\My_SQL\book\chapter_10\acs_2011_2015_stats.csv'
...
FROM 'C:\BootCamp\7_PostgresSQL\My_SQL\book\chapter_10\fbi_crime_data_2015.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
